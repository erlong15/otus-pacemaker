...
def main():
    ...
    all_opt["ssh_options"]["default"] = ""
    #"-t '/bin/bash -c \"" + r"PS1=\\[EXPECT\\]# HISTFILE=/dev/null " + "/bin/bash --noprofile --norc\"'"
...
if __name__ == "__main__":
    main()
RELEASE_VERSION="4.0.10.126-ba13-dirty"
BUILD_DATE="(built Sun Nov 20 21:13:42 UTC 2022)"